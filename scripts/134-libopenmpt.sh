...
make PREFIX=${BUILD_INSTALL_ROOT} AR=ar CONFIG=mingw64-win${ARCH} STATIC_LIB=1 SHARED_LIB=0 DYNLINK=0 EXAMPLES=0 OPENMPT123=0 TEST=0 NO_ZLIB=0 NO_MPG123=0 NO_OGG=0 NO_VORBIS=0 NO_VORBISFILE=1 NO_PORTAUDIO=1 NO_PORTAUDIOCPP=1 NO_PULSEAUDIO=1 NO_SDL=1 NO_SDL2=0 NO_SNDFILE=0 NO_FLAC=1 NO_STBVORBIS=1 $JOBS
